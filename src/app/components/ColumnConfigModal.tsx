      ...
      <div className="column-modal">
        ...
        <div className="column-modal-actions">
          ...
          <button
            type="button"
            className="btn"
            onClick={onPendingClearFilterColumns}
          >
            清空筛选
          </button>
          <button
        ...
        <div className="column-modal-list">
          {pendingFile.columns.map((column) => {
            ...
            const checkedFilter = pendingSelectedFilterKeys.includes(
              column.key,
            );
              ...
              >
                ...
                <label className="column-config-switch">
                  <input
                    ...
                    onChange={() => onTogglePendingDisplayColumn(column.key)}
                  />
                  <span>展示</span>
                </label>
                <label className="column-config-switch">
                  <input
                    ...
                    onChange={() => onTogglePendingFilterColumn(column.key)}
                  />
                  <span>筛选</span>
                </label>
                <label className="column-config-switch">
                  <input
                    ...
                    onChange={() => onTogglePendingEditableColumn(column.key)}
                  />
                  <span>可编辑</span>
                </label>
              </div>
        ...
        <div className="column-modal-footer">
          <button type="button" className="btn" onClick={onCancelPendingFile}>
            取消导入
          </button>
          <button
            type="button"
