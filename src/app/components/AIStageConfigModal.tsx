      ...
      <div className="column-modal ai-config-modal">
        ...
        <div className="ai-config-form">
          ...
          <div className="ai-config-stage-info">
            ...
            <span>{AI_STAGE_LABELS[activeStageKey].description}</span>
          </div>
          ...
          <div className="ai-config-section">
            ...
            <div className="ai-config-fields">
              {aiSubmitFieldColumns.map((column) => {
                const checked = stageConfig.submitFieldKeys.includes(
                  column.key,
                );
                return (
                  <label key={column.key} className="ai-config-field-item">
                    <input
                      ...
                      checked={checked}
                      onChange={() =>
                        onToggleDraftAISubmitField(activeStageKey, column.key)
                      }
                    />
